...
const routes: Routes = [
    ...
    {path: 'home-three', component: HomeOneComponent},
    ...
    {path: 'developer/:developer?', component: ProductsDetailsComponent},
    ...
    {path: 'listing-details/:properties?', component: ListingDetailsComponent},
